...
internal class InMemoryViewInserter : IInserter
{
    ...
    public InMemoryViewInserter(string connectionString, int workerCount)
    {
    ...
    public async Task InsertAsync()
    {
        ...
        if (_insertCommand == null)
        {
            ...
            _insertCommand.CommandText = "set nocount on; insert into dbo.TestAutoIncrementMemView (SomeData, AppKey, ThreadId, ThreadCount) VALUES (@SomeData, @AppKey, @ThreadId, @ThreadCount)";
