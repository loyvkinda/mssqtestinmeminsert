...
internal class InMemoryTableInserterIdentity : IInserter
{
    ...
    public InMemoryTableInserterIdentity(string connectionString, int workerCount)
    {
    ...
    public async Task InsertAsync()
    {
        ...
        if (_insertCommand == null)
        {
            ...
            _insertCommand.CommandText = "set nocount on; insert into dbo.TestAutoIncrementInMemIdentity (SomeData, AppKey, ThreadId, ThreadCount) VALUES (@SomeData, @AppKey, @ThreadId, @ThreadCount)";
